 ...
 * Roland. (2015, January 16). Gantt chart from scratch. Stack Overflow.
...
public class GanttChart<X,Y> extends XYChart<X,Y> {
    ...
    public static class ExtraData {
        ...
        public ExtraData(TaskScheduled taskScheduled, String styleClass) {
            super();
            this.length = taskScheduled.getFinishTime() - taskScheduled.getStartingTime();
